...
if(isset($_POST['nombre'], $_POST['apellidos'], $_POST['dni'],$_POST['f_nacimiento'], $_POST['email'], $_POST['contrasena'], $_POST['pais'])){
    ...
    if($verificadorDni===true && $verificadorEmail===true){
        $insertPerfil = "INSERT INTO perfil(iban, nombre, apellidos, dni, email,imagen, contrasena, fecha_nacimiento, direccion, ciudad, codigo_postal, provincia, pais, saldo) VALUES ('$iban','$nombre', '$apellidos', '$dni', '$email','../../img/perfil/usu.png', '$contrasena', '$f_nacimiento', 'null', 'null', 'null', 'null', '$pais', 'null')";
